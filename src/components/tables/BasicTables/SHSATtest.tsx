...
export default function ShsatTestPrepAdmin() {
  ...
  const initialState = {
    ...
    heroDescription: "",
    aboutMainHeading: "",
    aboutItems: [{ title: "", content: "" }], // Dynamic items for About section
    structureHeading: "",
    structurePoints: [""] // Bullet points list
  };
  ...
  const fetchData = async () => {
    try {
      ...
      if (res.data.data) {
        // Merge with initial state to handle any missing fields safely
  ...
  return (
    <div className="bg-gray-50 p-6 flex flex-col items-center min-h-screen">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-4xl border-t-4 border-blue-600 p-8">
        <h2 className="text-3xl font-bold text-center mb-8 text-blue-800">SHSAT Page Admin</h2>
        ...
        <div className="mb-8 border-b pb-6">
          ...
          <input 
            ...
            className="w-full mb-4 p-3 border rounded-lg focus:ring-2 focus:ring-blue-300 outline-none" 
          />

          <label className="text-sm font-semibold text-gray-600">Description (Top Paragraphs)</label>
          <textarea 
        ...
        <div className="mb-8 border-b pb-6">
          ...
          <label className="text-sm font-semibold text-gray-600">Main Heading</label>
          <input 
            name="aboutMainHeading" 
            value={form.aboutMainHeading} 
            onChange={handleChange} 
            placeholder="e.g. All About SHSAT" 
            className="w-full mb-6 p-3 border rounded-lg focus:ring-2 focus:ring-blue-300 outline-none" 
          />
            ...
            {form.aboutItems.map((item, index) => (
              <div key={index} className="bg-blue-50 p-4 rounded-xl border border-blue-100 relative">
                ...
                <input 
                  ...
                  placeholder="Heading (Blue Text) - e.g. Where do you take the SHSAT?" 
                ...
                <textarea 
                  ...
                  placeholder="Answer/Description (Black Text)..." 
                  rows={3} 
        ...
        <div className="mb-6">
          ...
          <label className="text-sm font-semibold text-gray-600">Heading</label>
          <input 
          ...
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
            <h4 className="font-semibold mb-3 text-gray-600">Bullet Points</h4>
            {form.structurePoints.map((point, index) => (
              <div key={index} className="flex gap-2 mb-2 items-center">
                ...
                <input 
                  ...
                  className="w-full p-2 border rounded focus:ring-1 focus:ring-blue-400" 
                />
                <button 
